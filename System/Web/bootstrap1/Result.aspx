    ...
    <div class="container">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="width:1000px">
            <div class="registrationform">
                <div class="form-horizontal">
                    <fieldset>
                        <legend>Results <i class="fa fa-pencil pull-right"></i></legend>
     ...
     <columns>  
         <asp:TemplateField HeaderText="Student ID">  
             <ItemTemplate>  
                 <asp:Label ID="LblCASGNName" runat="server" Text='<%#Bind("SID") %>'></asp:Label>  
             </ItemTemplate>  
         </asp:TemplateField>  
                  <asp:TemplateField HeaderText="Result">  
             <ItemTemplate>  
                 <asp:Label ID="LblCourseName" runat="server" Text='<%#Bind("BatchID") %>'></asp:Label>  
             </ItemTemplate>  
         </asp:TemplateField>  
         <asp:TemplateField HeaderText="Subject Name">  
             <ItemTemplate>  
                 <asp:Label ID="LblASGNID" runat="server" Text='<%#Bind("SubjectName") %>'></asp:Label>  
             </ItemTemplate>  
         </asp:TemplateField>  
         <asp:TemplateField HeaderText="Result">  
             <ItemTemplate>  
                 <asp:Label ID="LblCourseName" runat="server" Text='<%#Bind("Result") %>'></asp:Label>  
             </ItemTemplate>  
         </asp:TemplateField>  
